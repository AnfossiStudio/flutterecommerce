...
import 'package:ecommerceapp/Widgets/Favorite/AddToBag.dart';
import 'package:ecommerceapp/Widgets/Rating.dart';
import 'package:ecommerceapp/providers/ThemeApp.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class FavoriteCardGrid extends StatefulWidget {
  final int index;
  bool out = false;

  FavoriteCardGrid({@required this.index});

  @override
  _FavoriteCardGridState createState() => _FavoriteCardGridState();
}

class _FavoriteCardGridState extends State<FavoriteCardGrid> {
